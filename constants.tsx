...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    step: '03',
    title: 'DM Framework',
    subtitle: 'DM Sales Copywriter',
    description:
      'Built on the SLAP method. Stop the scroll. Lead with proof. Arouse curiosity. Position as shortcut. Four moves that flip ignored DMs into booked calls. Paste your thread, get the rewrite in your coach\'s voice.',
    ...
    features: [
      ...
      'AI DM rewriter in your coach\'s voice',
